        ...
        <div class="col-md-12 col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form class="form" action="{{route('admin.storeContent')}}" method="POST">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-label-group">
                                            <input type="text" class="form-control" placeholder="نام" name="title">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-label-group">
                                            <textarea class="form-control" placeholder="توضیحات" name="desc"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-label-group">
